...
func (db *Database) GetReader(root common.Hash) snapshot {
...
func (db *Database) Update(root common.Hash, parentRoot common.Hash, nodes map[common.Hash]map[string]*trienode.WithPrev) error {
