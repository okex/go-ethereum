...
func NewCustom(config Config, diskdb ethdb.KeyValueStore, triedb *trie.Database, root common.Hash, async bool, rebuild bool, recovery bool, retriever Retriever) (*Tree, error) {
...
func generateTrieRootCustom(db ethdb.KeyValueWriter, scheme string, it Iterator, account common.Hash, generatorFn trieGeneratorFn, leafCallback leafCallbackFn, stats *generateStats, report bool, retriever Retriever) (common.Hash, error) {
	var (
