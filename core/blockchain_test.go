...
func TestLastBlockHashBased(t *testing.T) { testLastBlock(t, rawdb.HashScheme) }
func TestLastBlockPathBased(t *testing.T) { testLastBlock(t, rawdb.PathScheme) }
...
func TestExtendCanonicalBlocksHashBased(t *testing.T) { testExtendCanonical(t, true, rawdb.HashScheme) }
func TestExtendCanonicalHeadersPathBased(t *testing.T) {
	testExtendCanonical(t, false, rawdb.PathScheme)
}
func TestExtendCanonicalBlocksPathBased(t *testing.T) { testExtendCanonical(t, true, rawdb.PathScheme) }
...
func TestShorterForkHeadersHashBased(t *testing.T) { testShorterFork(t, false, rawdb.HashScheme) }
func TestShorterForkBlocksHashBased(t *testing.T)  { testShorterFork(t, true, rawdb.HashScheme) }
func TestShorterForkHeadersPathBased(t *testing.T) { testShorterFork(t, false, rawdb.PathScheme) }
func TestShorterForkBlocksPathBased(t *testing.T)  { testShorterFork(t, true, rawdb.PathScheme) }
...
func TestLongerForkHeadersHashBased(t *testing.T) { testLongerFork(t, false, rawdb.HashScheme) }
func TestLongerForkBlocksHashBased(t *testing.T)  { testLongerFork(t, true, rawdb.HashScheme) }
func TestLongerForkHeadersPathBased(t *testing.T) { testLongerFork(t, false, rawdb.PathScheme) }
func TestLongerForkBlocksPathBased(t *testing.T)  { testLongerFork(t, true, rawdb.PathScheme) }
...
// forks do take canonical ownership.
func TestEqualForkHeadersHashBased(t *testing.T) { testEqualFork(t, false, rawdb.HashScheme) }
func TestEqualForkBlocksHashBased(t *testing.T)  { testEqualFork(t, true, rawdb.HashScheme) }
func TestEqualForkHeadersPathBased(t *testing.T) { testEqualFork(t, false, rawdb.PathScheme) }
func TestEqualForkBlocksPathBased(t *testing.T)  { testEqualFork(t, true, rawdb.PathScheme) }
...
func TestBrokenHeaderChainHashBased(t *testing.T) { testBrokenChain(t, false, rawdb.HashScheme) }
func TestBrokenBlockChainHashBased(t *testing.T)  { testBrokenChain(t, true, rawdb.HashScheme) }
func TestBrokenHeaderChainPathBased(t *testing.T) { testBrokenChain(t, false, rawdb.PathScheme) }
func TestBrokenBlockChainPathBased(t *testing.T)  { testBrokenChain(t, true, rawdb.PathScheme) }
...
func TestReorgLongHeadersHashBased(t *testing.T) { testReorgLong(t, false, rawdb.HashScheme) }
func TestReorgLongBlocksHashBased(t *testing.T)  { testReorgLong(t, true, rawdb.HashScheme) }
func TestReorgLongHeadersPathBased(t *testing.T) { testReorgLong(t, false, rawdb.PathScheme) }
func TestReorgLongBlocksPathBased(t *testing.T)  { testReorgLong(t, true, rawdb.PathScheme) }
...
// overwrites the canonical numbers and links in the database.
func TestReorgShortHeadersHashBased(t *testing.T) { testReorgShort(t, false, rawdb.HashScheme) }
func TestReorgShortBlocksHashBased(t *testing.T)  { testReorgShort(t, true, rawdb.HashScheme) }
func TestReorgShortHeadersPathBased(t *testing.T) { testReorgShort(t, false, rawdb.PathScheme) }
func TestReorgShortBlocksPathBased(t *testing.T)  { testReorgShort(t, true, rawdb.PathScheme) }
...
func TestBadHeaderHashesHashBased(t *testing.T) { testBadHashes(t, false, rawdb.HashScheme) }
func TestBadBlockHashesHashBased(t *testing.T)  { testBadHashes(t, true, rawdb.HashScheme) }
func TestBadHeaderHashesPathBased(t *testing.T) { testBadHashes(t, false, rawdb.PathScheme) }
func TestBadBlockHashesPathBased(t *testing.T)  { testBadHashes(t, true, rawdb.PathScheme) }
...
func TestReorgBadHeaderHashesHashBased(t *testing.T) { testReorgBadHashes(t, false, rawdb.HashScheme) }
func TestReorgBadBlockHashesHashBased(t *testing.T)  { testReorgBadHashes(t, true, rawdb.HashScheme) }
func TestReorgBadHeaderHashesPathBased(t *testing.T) { testReorgBadHashes(t, false, rawdb.PathScheme) }
func TestReorgBadBlockHashesPathBased(t *testing.T)  { testReorgBadHashes(t, true, rawdb.PathScheme) }
...
func TestFastVsFullChainsHashBased(t *testing.T) { testFastVsFullChains(t, rawdb.HashScheme) }
func TestFastVsFullChainsPathBased(t *testing.T) { testFastVsFullChains(t, rawdb.PathScheme) }
...
func TestChainTxReorgsHashBased(t *testing.T) { testChainTxReorgs(t, rawdb.HashScheme) }
func TestChainTxReorgsPathBased(t *testing.T) { testChainTxReorgs(t, rawdb.PathScheme) }
...
func TestLogReorgsHashBased(t *testing.T) { testLogReorgs(t, rawdb.HashScheme) }
func TestLogReorgsPathBased(t *testing.T) { testLogReorgs(t, rawdb.PathScheme) }
...
func TestLogRebirthHashBased(t *testing.T) { testLogRebirth(t, rawdb.HashScheme) }
func TestLogRebirthPathBased(t *testing.T) { testLogRebirth(t, rawdb.PathScheme) }
...
func TestSideLogRebirthHashBased(t *testing.T) { testSideLogRebirth(t, rawdb.HashScheme) }
func TestSideLogRebirthPathBased(t *testing.T) { testSideLogRebirth(t, rawdb.PathScheme) }
...
func TestReorgSideEventHashBased(t *testing.T) { testReorgSideEvent(t, rawdb.HashScheme) }
func TestReorgSideEventPathBased(t *testing.T) { testReorgSideEvent(t, rawdb.PathScheme) }
...
func TestEIP155TransitionHashBased(t *testing.T) { testEIP155Transition(t, rawdb.HashScheme) }
func TestEIP155TransitionPathBased(t *testing.T) { testEIP155Transition(t, rawdb.PathScheme) }
...
func TestEIP161AccountRemovalHashBased(t *testing.T) { testEIP161AccountRemoval(t, rawdb.HashScheme) }
func TestEIP161AccountRemovalPathBased(t *testing.T) { testEIP161AccountRemoval(t, rawdb.PathScheme) }
...
func TestLargeReorgTrieGCHashBased(t *testing.T) { testLargeReorgTrieGC(t, rawdb.HashScheme) }
func TestLargeReorgTrieGCPathBased(t *testing.T) { testLargeReorgTrieGC(t, rawdb.PathScheme) }
...
func TestBlockchainRecoveryHashBased(t *testing.T) { testBlockchainRecovery(t, rawdb.HashScheme) }
func TestBlockchainRecoveryPathBased(t *testing.T) { testBlockchainRecovery(t, rawdb.PathScheme) }
...
func TestLowDiffLongChainHashBased(t *testing.T) { testLowDiffLongChain(t, rawdb.HashScheme) }
func TestLowDiffLongChainPathBased(t *testing.T) { testLowDiffLongChain(t, rawdb.PathScheme) }
...
func TestDeleteCreateRevertHashBased(t *testing.T) { testDeleteCreateRevert(t, rawdb.HashScheme) }
func TestDeleteCreateRevertPathBased(t *testing.T) { testDeleteCreateRevert(t, rawdb.PathScheme) }
...
func TestDeleteRecreateSlotsHashBased(t *testing.T) { testDeleteRecreateSlots(t, rawdb.HashScheme) }
func TestDeleteRecreateSlotsPathBased(t *testing.T) { testDeleteRecreateSlots(t, rawdb.PathScheme) }
...
func TestDeleteRecreateAccountHashBased(t *testing.T) { testDeleteRecreateAccount(t, rawdb.HashScheme) }
func TestDeleteRecreateAccountPathBased(t *testing.T) { testDeleteRecreateAccount(t, rawdb.PathScheme) }
...
// correctly.
func TestEIP2718TransitionHashBased(t *testing.T) { testEIP2718Transition(t, rawdb.HashScheme) }
func TestEIP2718TransitionPathBased(t *testing.T) { testEIP2718Transition(t, rawdb.PathScheme) }
...
func TestEIP1559TransitionHashBased(t *testing.T) { testEIP1559Transition(t, rawdb.HashScheme) }
func TestEIP1559TransitionPathBased(t *testing.T) { testEIP1559Transition(t, rawdb.PathScheme) }
...
func TestSetCanonicalHashBased(t *testing.T) { testSetCanonical(t, rawdb.HashScheme) }
func TestSetCanonicalPathBased(t *testing.T) { testSetCanonical(t, rawdb.PathScheme) }
...
func TestCanonicalHashMarkerHashBased(t *testing.T) { testCanonicalHashMarker(t, rawdb.HashScheme) }
func TestCanonicalHashMarkerPathBased(t *testing.T) { testCanonicalHashMarker(t, rawdb.PathScheme) }
